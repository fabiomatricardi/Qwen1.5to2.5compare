...
# models/qwen2-1_5b-instruct-q5_k_m.gguf
import sys
...
# create THE LOG FILE 
logfile = f'QWEN2-1.5b_{genRANstring(5)}_log.txt'
logfilename = logfile
...
llm = Llama(
            model_path='models/qwen2-1_5b-instruct-q5_k_m.gguf',
...
print("2. Model qwen2-1_5b-instruct-q5_k_m.gguf loaded with LlamaCPP...")
