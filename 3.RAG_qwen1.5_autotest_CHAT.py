...
# models/qwen1_5-1_8b-chat-q5_k_m.gguf
import sys
...
# create THE LOG FILE 
logfile = f'QWEN1.5-1.8b_{genRANstring(5)}_log.txt'
logfilename = logfile
...
llm = Llama(
            model_path='models/qwen1_5-1_8b-chat-q5_k_m.gguf',
...
print("2. Model qwen1_5-1_8b-chat-q5_k_m.gguf loaded with LlamaCPP...")
